    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/85 backdrop-blur">
      <div className="container mx-auto flex h-14 items-center justify-between gap-4">
        ...
        <nav aria-label="Main navigation" className="flex items-center gap-1 text-sm text-muted-foreground">
          ...
          <span className="mx-1" />
          <ThemeToggle />
          <a href="http://bitsandbytesdude.vercel.app" target="_blank" rel="noopener noreferrer" className="ml-4 text-sm font-medium text-muted-foreground hover:text-foreground">Powered by BITSANDBYTESDUDE</a>
        </nav>
      </div>
    </header>
  );
